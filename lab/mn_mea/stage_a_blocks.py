...
#: хвосты теряются. Доля выбрана замером, см. validate.experiment_block_window:
#: 0,5 даёт лучшую картинку; при 1,0 остаток фазы падает ещё, но контраст
#: собранной сцены УХУДШАЕТСЯ — окно захватывает землю, где поправка уже
#: другая, а это ровно то, против чего и сделано разбиение (5-20).
BLOCK_OVERLAP_FRACTION = 0.5
